...
\subsection{\textsc{PopsSample} average complexity}
...
\subsection{The motivation behind
            \textsc{PoPS}\label{sampling}}
...
\subsection{\textsc{PopsSample} during hard
...
\subsection{\textsc{PoPS} vs.\ other search methods}
...
\begin{table}
  \centering
  \caption{Solution costs for fourteen ITC
