...
\subsection{Defining search methods recursively}

In our CP-MR schema, we do \emph{not} make assignments using
a constant variable ordering. On the contrary, we define a
declarative way to describe ad hoc sequential search
methods.

\subsubsection{Search methods are goal-driven}
...
\subsubsection{Defining DFS using goals}
...
\subsubsection{The goals are the search tree nodes}
