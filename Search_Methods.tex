...
Programming solver.\cite{Naxos} The solution phase is
completely independent to the CSP declaration phase, as this
serves the original promise of Constraint Programming:
\emph{The user states the problem, the computer solves
it.}\cite{Freuder2014}
...
\begin{itemize}
  ...
  \item We made a more thorough presentation of
        ...
        Example~\ref{heuristics-pie2}~\commit{bcf8}.
...
\begin{enumerate}
  \item The textbook \emph{Artificial Intelligence: A Modern
        Approach} has been cited~\commit{9149}.
