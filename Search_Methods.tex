...
\begin{itemize}
  ...
  \item Indeed, related work (Section~\ref{related-work}) is
        presented late, at least in relation to what
        somebody expects when reading a paper. However, this
        is done because Section~\ref{preliminaries} seems
        necessary to be read to understand it and because
        the preceding Section~\ref{search-framework} has
        different related work.
  \item We added a new related work subsection for local
        search methods and compared our contribution with
        simulated annealing~\commit{03b1}.
  ...
  \item We enriched Example~\ref{heuristics-pie} with more
        ...
        Finally, we compared our search method with
        LDS~\commit{1468}.
...
\begin{enumerate}
  ...
  \item Other solvers do solve a correctly defined CSP. We
        made a small rephrasing to be clearer with
        this~\commit{474e}.
