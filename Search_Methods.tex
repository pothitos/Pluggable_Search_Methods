...
of this paper to analyze further.\cite{AC}
...
visible in the corresponding subfigures of Figures
\ref{abcd} to \ref{tuv}:
\begin{enumerate}
  ...
  \item[(b)] \textsc{Solve} begins and pops the
             ...
             This \textsf{AND} goal is then popped in turn
             by the next \textsc{Solve} iteration and after
             its execution returns its two subgoals
  ...
  \item[(c)] By definition, \texttt{Instantiate}($\{X_1\}$)
             ...
             \begin{enumerate}
               ...
               \item[3.] If any of the above fails, undo all
                         ...
                         subgoal.
             \end{enumerate}
             In Fig.~\ref{abcd}(c), all three requirements
             ...
             stack in Fig.~\ref{abcd}(c), we ``unwrapped''
             it and added directly its two subgoals.
  \item[(d)] 
  \item[(e)] 
  \item[(f)] 
  \item[(g)] 
...
\begin{figure}
  ...
  \caption{\textsc{Solve} with DFS example: $X_2$
...
\begin{figure}
  ...
  \caption{\textsc{Solve} with DFS example: $X_2$ successful
           instantiation\label{ijkl}}
\end{figure}

\begin{figure}
  \includegraphics[width=\textwidth]{figures/stacks/mnop}
  \caption{\textsc{Solve} with DFS example: $X_3$
