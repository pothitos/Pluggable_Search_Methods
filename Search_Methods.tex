      ...
      \While {time limit has not been reached}
        ...
        \Else
          ...
          \State $\mathrm{stackOr.top.delayedGoal} \gets
                 ...
                 the \\ \hspace{7em} stackOr frame that
                 ``delayedGoal'' points to \Or (if there is
                 not such a goal) get the next delayed goal
                 of that stackOr frame
        \EndIf
        ...
        \Else
          ...
          \ElsIf {stackOr.top.stackAnd is empty \And \\
                  \hspace{7em}
                  $\mathrm{stackOr.top.delayedGoal} =
                  \texrm{null}$}
            \Return true \Comment {Success}
          \EndIf
        \EndIf
      \EndWhile
      \Return false
