  ...
  \item The ``stack of stacks'' data structure along with
        ...
        \begin{enumerate}
          ...
          \item Most importantly, even if we suppose that
                ...
                Programming\cite{grand-challenges} and has
                to be documented. Even if the ``stack of
                stacks'' is implemented in many paradigms,
                this doesn't mean that every implementation
                is modular, extendible, documented, and
