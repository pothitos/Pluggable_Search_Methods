...
comments and suggestions. The hexadecimal numbers inside
brackets below link to the corresponding patches that were
made to the document's source code.
...
\begin{enumerate}
  \item Title was changed to reflect the paper's
        ...
        Solver}~\texttt{[\href{https://github.com/pothitos/Search_Methods/commit/6d3a}{6d3a}]}.
  \item Typo
        fixed~\texttt{[\href{https://github.com/pothitos/Search_Methods/commit/ea7d}{ea7d}]}.
\end{enumerate}
